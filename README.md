...
This repository contains scripts and data that used for characterizing respiratory microbiome of the manuscript "Comprehensive lung microbial gene and genome catalogs assist the mechanism survey of *Mesomycoplasma hyopneumoniae* strains causing pig lung lesions".
