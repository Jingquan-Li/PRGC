...
top20_hl_add$spec_hl <- rownames(top20_hl_add)
top20_hl_add.melt <- melt(top20_hl_add)
###core species in HL
ggplot(top20_hl_add.melt, aes(x=spec_hl, y=value))+ 
...
top20_svll_add$spec_svll <- rownames(top20_svll_add)
top20_svll_add.melt <- melt(top20_svll_add)

###core species in SVLL
ggplot(top20_svll_add.melt, aes(x=spec_svll, y=value))+ 
